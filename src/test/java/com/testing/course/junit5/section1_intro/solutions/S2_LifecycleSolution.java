...
class S2_LifecycleSolution {
    ...
    static void beforeAllTests() {
        ...
        System.out.println("🚀 Inicio de la suite de tests S2_LifecycleSolution");
    }
    ...
    static void afterAllTests() {
        ...
        System.out.println("🏁 Fin de la suite de tests S2_LifecycleSolution");
    }
}
